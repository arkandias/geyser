...
export type AdminRoleFragment = { __typename?: 'TeacherRole', id: number, role: RoleEnum, comment?: string | null, teacher: { __typename?: 'Teacher', email: string, displayname?: string | null } } & { ' $fragmentName'?: 'AdminRoleFragment' };
