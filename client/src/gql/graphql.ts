...
export type AdminCoordinationCourseFragment = { __typename?: 'Coordination', id: number, comment?: string | null, teacher: { __typename?: 'Teacher', email: string }, course?: { __typename?: 'Course', name: string, semester: number, program: { __typename?: 'Program', name: string, degree: { __typename?: 'Degree', name: string } }, track?: { __typename?: 'Track', name: string } | null, type: { __typename?: 'CourseType', label: string } } | null } & { ' $fragmentName'?: 'AdminCoordinationCourseFragment' };
